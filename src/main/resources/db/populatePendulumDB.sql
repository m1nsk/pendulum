...
INSERT INTO devices (user_id, name, serial) VALUES
  (100000, '1', 100002),
  (100000, '2', 100003),
  (100001, '3',100004);

INSERT INTO channels (user_id, name, current_message) VALUES
  (100000, 'channel1',100000),
  (100000, 'channel2',100001),
  (100001, 'channel3',100002);
